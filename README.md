...
[![Build Status](https://travis-ci.org/apraditya/flipter.svg?branch=master)](https://travis-ci.org/apraditya/flipter) [![Dependency Status](https://david-dm.org/apraditya/flipter.svg)](https://david-dm.org/apraditya/flipter) [![devDependency Status](https://david-dm.org/apraditya/flipter/dev-status.svg)](https://david-dm.org/apraditya/flipter#info=devDependencies)
...
## Release History
 * 2015-01-19   v0.1.0   Generated by the [Yeoman Generator](https://github.com/FamousTools/generator-famous) for [Famo.us](http://famo.us)